...
static LPCWSTR REG_VALUE_EXCLUDEDOUS = L"ExcludedOUs";
static LPCWSTR REG_VALUE_INCLUDEDOUS = L"IncludedOUs";
static LPCWSTR REG_VALUE_EXCLUDEDGROUPS = L"ExcludedGroups";
static LPCWSTR REG_VALUE_INCLUDEDGROUPS = L"IncludedGroups";
